...
// console.log("(m/s): " + msSpeed);

// task-06
// let year = Number (prompt ("Enter your Birth year: "));
// let age = 2023 - parseInt(year);
// console.log("(age): " + age * 365);

// task-07
// let num = 2;
// let FifthPower = Math.pow(num, 5);
// let dividedBy3 = num / 3;
// console.log("Number raised to the fifth power: " + FifthPower);
// console.log("The number divided by 3: " + dividedBy3);
